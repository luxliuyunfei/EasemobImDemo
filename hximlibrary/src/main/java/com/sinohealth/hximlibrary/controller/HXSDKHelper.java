...
import com.sinohealth.hximlibrary.model.HXNotifier;
...
public abstract class HXSDKHelper {
    ...
    public synchronized boolean onInit(Context context){
        ...
        if(hxModel == null){
            hxModel = new DefaultLibModel(appContext);
        }
    ...
    /**
     * the subclass must override this class to provide its own model or directly use {@link DefaultLibModel}
     * @return
     */
