 ...
 */
package com.sinohealth.hximlibrary.adapter;
...
import com.sinohealth.hximlibrary.controller.HXSDKHelper;
...
import com.sinohealth.hximlibrary.utils.SmileUtils;
...
//				}
	...
	public int getItemViewType(int position) {
		...
		if (message.getType() == EMMessage.Type.TXT) {
			...
			else if(((ImLibHelper) HXSDKHelper.getInstance()).isRobotMenuMessage(message))
